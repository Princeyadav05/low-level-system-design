# Design Trello Low Level System Design
...
### User
- Each user should have a userId, name, email.

### Board
- Each board should have a id, name, privacy (PUBLIC/PRIVATE), url, members, lists
